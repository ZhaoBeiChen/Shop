...
<head>
    <meta charset="utf-8">
    <title>PersonalPasswdChange</title>
...
<div class="bg_01">
    ...
    <div class="InfoChange_bg_01" style="height: 550px">
        <form action="controller/DelPersonalPasswdChange" method="post">
            <p class="InfoChange_header" style="width: 150px; margin-left: 40px; margin-top: 120px"><font color="gray">Old PassWord:</font></p>
            <input class="InfoChange_text" name="infoChangePW_oldPW" value="" style="margin-top: 120px; margin-left: 10px" type="password" />
            <p class="InfoChange_header" style="width: 150px; margin-left: 40px; clear: both"><font color="gray">New PassWord:</font></p>
            <input class="InfoChange_text" name="infoChangePW_newPW" value="" style="margin-top: 50px; margin-left: 10px" type="password" />
            <p class="InfoChange_header" style="width: 180px; margin-left: 10px; clear: left"><font color="gray">Confirm PassWord:</font></p>
            <input class="InfoChange_text" name="infoChangePW_conPW" value="" style="margin-top: 50px; margin-left: 10px;" type="password" />
            <input class="InfoChange_but" style="margin-left: 40px" type="submit" value="Confirm Change" />
        </form>
    </div>
